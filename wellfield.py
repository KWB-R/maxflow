...
bar_width = 0.35
plt.bar(data ['index'], budget_incremental["MNW2_OUT"].as_matrix()*perlen, bar_width, label="Out: MNW2")
plt.bar(data ['index'] + bar_width, budget_incremental["STORAGE_IN"].as_matrix()*perlen, bar_width, color='r', label="In: storage")
plt.bar(data ['index'] + bar_width, budget_incremental["CONSTANT_HEAD_IN"].as_matrix()*perlen, bar_width, color= 'orange', label="In: constant head")
#plt.bar(data ['index'], budget_incremental["MNW2_IN"].as_matrix()*perlen, bar_width, color= 'yellow', label="In: MNW2")
